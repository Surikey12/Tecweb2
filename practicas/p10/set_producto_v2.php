...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM libros WHERE nombre = '$nombre' AND marca = '$marca' AND modelo = '$modelo'";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO libros (nombre, marca, modelo, precio, detalles, unidades, imagen) VALUES ('$nombre', '$marca', '$modelo', '$precio', '$descripcion', '$unidades', '$imagen')";
        if($link->query($sql)){
