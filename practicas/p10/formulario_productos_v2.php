  ...
  <body>
    ...
    <form action="http://localhost/tecweb/practicas/p10/update_producto.php" method ="post">
        <fieldset>
            ...
            <li>Modelo: <input type="text" name="modelo" maxlength="25" required value="<?= !empty($_POST['modelo'])?$_POST['modelo']:$_GET['modelo'] ?>"> </li>
            <li>Precio: <input type="number" step="any" name="precio" min="100" required value="<?= !empty($_POST['precio'])?$_POST['precio']:$_GET['precio'] ?>"> </li>
            <li>Unidades: <input type="number" name="unidad" min="0" required value="<?= !empty($_POST['unidades'])?$_POST['unidades']:$_GET['unidades'] ?>"> </li>
            <li>Descripción <br> 
            <textarea name="desc" rows="4" cols="60" maxlength="250" placeholder="Ejemplo: Color, tamaño, diseño, etc."><?= !empty($_POST['detalles'])?$_POST['detalles']:$_GET['detalles'] ?></textarea>
            </li>
            <li>Imagen: <br>
        ...
        <div style="text-align: center">
            <input type="submit" value="Agregar Producto" onclick="VerificarImagen()"> 
